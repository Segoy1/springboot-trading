...
class OrderCancelServiceImpl implements OrderCancelService {
    ...
    private final OrderCancelApiCaller orderCancelApiCaller;
    ...
    public OrderCancelServiceImpl(EClientSocket client, OrderDataRepository orderDataRepository, OrderCancelApiCaller orderCancelApiCaller, ApiResponseCheckerForOptional<OrderData> orderDataApiResponseChecker, OrderCancelDeleteService orderCancelDeleteService) {
        this.client = client;

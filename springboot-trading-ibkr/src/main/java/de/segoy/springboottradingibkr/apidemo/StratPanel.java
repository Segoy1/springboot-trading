...
import de.segoy.springboottradingibkr.apidemo.util.VerticalPanel.BorderPanel;
import de.segoy.springboottradingibkr.apidemo.util.VerticalPanel.HorzPanel;
import de.segoy.springboottradingibkr.apidemo.util.VerticalPanel.StackPanel;
...
public class StratPanel extends StackPanel implements IHistoricalDataHandler, IRealTimeBarHandler {
	...
	final private OrdersPanel.OrdersModel m_ordersModel = new OrdersPanel.OrdersModel();

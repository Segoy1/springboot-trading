...
class HistoricalDataApiCallerTest {
    ...
    void testApiCall(){
        ...
        when(contractDataToIBKRContract.convertContractData(settings.getContractData())).thenReturn(contract);
        ...
        verify(contractDataToIBKRContract, times(1)).convertContractData(contractData);

...
export class OrderCancelService {
  ...
  private singleCancelUrl: string = environmentDevelopment.apiUrl+'order/cancel-order';
  private allCancelUrl: string = environmentDevelopment.apiUrl+'order/cancel-all-open-orders';
